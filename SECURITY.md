...
We actively support the following versions of `reca` with security updates:
...
We take the security of `reca` seriously. If you discover a security vulnerability, please follow these steps:

### How to Report

1. **DO NOT** open a public GitHub issue for security vulnerabilities
2. Send a detailed report to the repository maintainer via:
   - GitHub Security Advisory: [Report a vulnerability](https://github.com/LabEG/reca/security/advisories/new)
   - Email: Create an issue in the [issue tracker](https://github.com/LabEG/reca/issues) marked as **Security** (if no sensitive details need to be shared)
...
- **Version**: The version of `reca` affected
- **Environment**: Relevant environment details (Node.js version, React version, etc.)
...
This package relies on React and minimal dependencies. We:
...
As a state management library, `reca`:

- **Runs in client-side applications** - ensure proper data sanitization
- **Does not access network resources directly** - network calls are in your code
- **State management only** - security of data depends on your implementation
- **Client-side state** - sensitive data should not be stored in client state
...
- Open a [GitHub Security Advisory](https://github.com/LabEG/reca/security/advisories/new)
- Create an issue at: <https://github.com/LabEG/reca/issues>

---

Thank you for helping keep `reca` and its users safe!
